package com.ucorp.ecom.security;
...
import com.ucorp.ecom.security.jwt.AuthEntryPointJwt;
import com.ucorp.ecom.security.jwt.AuthTokenFilter;
import com.ucorp.ecom.security.service.UserDetailServiceImpl;
...
public class WebSecurityConfig {
    ...
    public CommandLineRunner initData(RoleRepository roleRepository, UserRepository userRepository,
        ...
        return args -> {
            ...
            //Create user if not alredy present
            ...
            if (!userRepository.existsByUserName("seller1")){
                ...
                //user1.setRole(sellerRoles);
                userRepository.save(seller1);
            }
            if (!userRepository.existsByUserName("admin")){
                User user1 = new User("admin","admin@example.com",passwordEncoder.encode("adminPass"));
